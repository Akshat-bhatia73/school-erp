...
const YEAR = { id: 'year-1', schoolId: SCHOOL_ID, name: '2026-27', startDate: '2026-04-01', endDate: '2027-03-31', status: 'current' as const, version: 3 }
const GRADE = { id: 'grade-1', schoolId: SCHOOL_ID, name: 'Class 6', shortName: '6', order: 6, version: 1 }
const SECTION = { id: 'section-1', schoolId: SCHOOL_ID, gradeId: GRADE.id, academicYearId: YEAR.id, name: 'A', capacity: 40, version: 2 }
const HOLIDAY = {
...
describe('Subjects', () => {
  it('hides the class mapping tab when classes cannot be read', async () => {
    setup.subjects.mockResolvedValue([{ id: 'sub-1', schoolId: SCHOOL_ID, name: 'Mathematics', code: 'MATH', type: 'scholastic', version: 1 }])
