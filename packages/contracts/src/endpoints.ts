...
export const ACCESS_ENDPOINTS = {
  ...
  members: { method: 'GET', path: '/api/schools/:schoolId/members', auth: 'membership', permission: 'members.read', params: SchoolParams, query: MemberListRequest, response: pageOf(MemberSummary), successStatus: 200 },
...
export const LIFECYCLE_ENDPOINTS = {
  ...
  subjectAccess: { method: 'GET', path: '/api/schools/:schoolId/students/:studentId/subject-access', auth: 'membership', permission: 'students.export_subject', params: StudentParams, response: SubjectAccessExport, successStatus: 200 },
