...
The assessment itself is left as it was written. What has changed since is marked in the finding tables: Task 12 closed F1, F2, F3, F4, F5, F9, F13, F14 and F15 on 18 September 2026, and each of those rows names the file that closes it. F6, F7, F8, F10, F11, F12 and F19 are Task 13; F16, F17 and F18 are Task 14. The retention schedule in section 7 is now adopted rather than proposed.
